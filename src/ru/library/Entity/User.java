...
public class User {
    ...
    /////////////// Constructor ///////////////////
    public User(int id_u, String famil_u, String name_u, String otch_u, Date dr_u, String login_u, String pass_u, boolean status_u, int rol_u) {
        this.id_u = id_u;
    ...
    public void setDr_u(Date dr_u) { this.dr_u = dr_u; }
    ...
    public Date getDr_u() { return dr_u; }
